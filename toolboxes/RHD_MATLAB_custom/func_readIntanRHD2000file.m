function func_readIntanRHD2000file(fullpath)

%Loads all data from an Intan .rhd file into the matlab workspace. This
% code is a carbon copy of the original "read_Intan_RHD2000_file.m"
% distributed by Intan, expect that this version works programatically
% instead of requiring interactive user input. Hope this works!
%
% Author: Ed Bello
